...
def find_main_channel(inundated_river_ftc, damFeat):
    ...
    if debug_mode == True:
        ...
        print(" [delineate_river] inundated_river_ftc", inundated_river_main_ftc.getInfo(),"\n")
...
def polygon_to_lines(poly_ftc):
    ...
    poly_boundaries_ftc = ee.FeatureCollection(
      poly_line_pts_list.map(pts_to_linestring)
    )
    
    poly_boundaries_ftc = poly_boundaries_ftc.map(lambda rfeat : remove_property(rfeat, 'pt_start'))
    poly_boundaries_ftc = poly_boundaries_ftc.map(lambda rfeat : remove_property(rfeat, 'pt_end'))
...
def delineate_river(damFeat, res_ftc, c_dam_id_str):
    ...
    if cfg.exportSimplifiedReservoirBoundary == True: 
        ...
        try:
            ...
            heet_export.export_ftc(sres_boundaries_ftc, c_dam_id_str, "simple_reservoir_boundary")
    ...
    if debug_mode == True:
        print("[DEBUG] [delineate_river] reaches_sres_ftc", reaches_sres_ftc.getInfo(),"\n")
    ...
    if debug_mode == True:
        print("[DEBUG] [delineate_river] reaches_sres_iolet_ftc", reaches_sres_iolet_ftc.getInfo(),"\n")
    ...
    if debug_mode == True:
        print("[DEBUG] [delineate_river] ssas", reaches_sres_iolet_ssas_ftc.getInfo(),"\n")
        print("[DEBUG] [delineate_river] ssource", reaches_sres_iolet_ssource_ftc.getInfo(),"\n")
        print("[DEBUG] [delineate_river] ssink", reaches_sres_iolet_ssink_ftc.getInfo(),"\n")
        print("[DEBUG] [delineate_river] csas", reaches_sres_iolet_csas_ftc.getInfo(),"\n")
        print("[DEBUG] [delineate_river] csource", reaches_sres_iolet_csource_ftc.getInfo(),"\n")
        print("[DEBUG] [delineate_river] csink", reaches_sres_iolet_csink_ftc.getInfo(),"\n")             
        print("[DEBUG] [delineate_river] other", inundated_river_other_ftc.getInfo(),"\n")
    ...
    def reach_to_lines_source_ftc(rfeat):
        ...
        reach_lines_ftc = ee.FeatureCollection(
            reach_line_pts_list.map(pts_to_linestring)
        )
        ...
        if debug_mode == True:
            ...
            print("[reach_to_lines_ftc] Reach Start Points List", reach_start_points_list.getInfo(),"\n")
            print("[reach_to_lines_ftc] Reach End Points List", reach_end_points_list.getInfo(),"\n")
            print("[reach_to_lines_ftc] Reach Line Coords List", reach_line_pts_list.getInfo(),"\n")
        ...
        def truncate_source_line(lines_iolet_ftc):
           ...
           # Identify Line Segments Outside Reservoir to Discard
            ...
            if debug_mode == True:
                print("[DEBUG] [truncate_source_line] lines_iolet_list", lines_iolet_list.getInfo(),"\n")
            ...
            line_to_trim_ft =  ee.Feature(
                lines_iolet_list.slice(retain_from_index, ee.Number(retain_from_index).add(1), 1).get(0)
            )
            ...
            if debug_mode == True:
                ...
                print(" [truncate_source_reach] Filtered Boundary Pts", boundary_pts_filtered_ftc.getInfo())
            ...
            if debug_mode == True:
                print(" [truncate_source_reach] Trimmed Source Line", trimmed_line_ftc.getInfo(),"\n")
                print(" [truncate_source_reach] Selected Source Lines List", selected_lines_list.getInfo(),"\n")
                print(" [truncate_source_reach] Selected Source Lines FTC", selected_lines_ftc.getInfo(),"\n")
    ...
    def reach_to_lines_sink_ftc(rfeat):
        ...
        def truncate_sink_line(lines_iolet_ftc):
            ...
            if debug_mode == True:
                print("[DEBUG] [truncate_sink_line] lines_iolet_list", lines_iolet_list.getInfo(),"\n")
            ...
            if debug_mode == True:
                print("[DEBUG] [truncate_sink_line] line_to_trim_ft", line_to_trim_ft.getInfo(),"\n")
            ...
            if debug_mode == True:
                print("[DEBUG] [truncate_sink_line] selected_lines_list", selected_lines_list.getInfo(),"\n")
            ...
            if debug_mode == True:
                print("[DEBUG] [truncate_sink_line] pt_start, pt_end, ", pt_start.getInfo(),  pt_end.getInfo(),"\n")
            ...
            if debug_mode == True:
                ...
                print(" [truncate_sink_reach] Filtered Boundary Pts", boundary_pts_filtered_ftc.getInfo())                
            ...
            if debug_mode == True:
                print("[DEBUG] [truncate_sink_line] trimmed_line_geom", trimmed_line_geom.getInfo(),"\n")
   ...
   #==========================================================================
    ...
    if cfg.exportSinkLines == True: 
        ...
        try:
            logger.info(f'{msg} {c_dam_id_str}')
            heet_export.export_ftc(inundated_river_csink_ftc, c_dam_id_str, "river_sink_lines")
   ...
   #==========================================================================
    ...
    if cfg.exportSourceLines == True: 
        ...
        try:
            logger.info(f'{msg} {c_dam_id_str}')
            heet_export.export_ftc(inundated_river_csource_ftc, c_dam_id_str, "river_source_lines")
    ...
    if debug_mode == True:
         print("[DEBUG]")        
         print("[DEBUG][delineate_river] Pre-flatten inundated_river_ftc", inundated_river_cftc.getInfo(),"\n")
...
def batch_delineate_rivers(c_dam_ids) :
    ...
    for c_dam_id in c_dam_ids:  
        ...
        if cfg.exportMainRiver == True:
            ...
            try:
                logger.info(f' {msg} {c_dam_id_str}')
                heet_export.export_ftc(mainRiverVector, c_dam_id_str, "main_river_vector")
...
if __name__ == "__main__":
    ...
    reservoirAssetName = "users/KamillaHarding/XHEET/AFRICA2_20220222-1303/R_3077"
    res_ftc = ee.FeatureCollection(reservoirAssetName)
    
    snappedAssetName =  "users/KamillaHarding/XHEET/AFRICA2_20220222-1303/PS_3077"
    damFeat = ee.FeatureCollection(snappedAssetName)
        
    mainRiverVector, riverVector = delineate_river(damFeat, res_ftc, "3130")
