...
export_job_specs = {
    ...
    "reservoir_buffer_zone" :  {
        "id": "014", "desc": "Reservoir Buffer Zone", "fileprefix": "rbz_", "taskcode" : "sres_bzone"
    },     
    "simple_reservoir_vector" :  {
        "id": "015", "desc": "Simple reservoir vector", "fileprefix": "sr_", "taskcode" : "sres_vec"
    }, 
    "simple_reservoir_boundary" :  {
        "id": "016", "desc": "Simple reservoir boundary", "fileprefix": "rb_", "taskcode" : "sres_bvec"
    }, 
    "river_vector" :  {
        "id": "017", "desc": "All river vector", "fileprefix": "S_", "taskcode" : "riv_vec"
    }, 
    "main_river_vector" :  {
        "id": "018", "desc": "Main river vector", "fileprefix": "ms_", "taskcode" : "mriv_vec"
    },
    "main_river_vector_params" :  {
        "id": "019", "desc": "Params main river vector", "fileprefix": "MS_", "taskcode" : "mriv_vec_params"
    },
    "river_sink_lines" :  {
        "id": "020", "desc": "River sink lines", "fileprefix": "sl1_", "taskcode" : "sink_vec"
    }, 
    "river_source_lines" :  {
        "id": "021", "desc": "River source lines", "fileprefix": "sl2_", "taskcode" : "source_vec"
    },
    "output_parameters" :  {
        "id": "022", "desc": "All output parameters", "fileprefix": "output_parameters", "taskcode" : "out_tab"
    },    
    "debugging_vector" :  {
...
def generate_json_output(out_ft):
    ...
    entry = {
        "monthly_temps": 
        [
            float(out_ft.get('r_mean_temp_1').getInfo()) if out_ft.get('r_mean_temp_1').getInfo() not in missing_codes else out_ft.get('r_mean_temp_1').getInfo(),
            float(out_ft.get('r_mean_temp_2').getInfo()) if out_ft.get('r_mean_temp_2').getInfo() not in missing_codes else out_ft.get('r_mean_temp_2').getInfo(), 
            float(out_ft.get('r_mean_temp_3').getInfo()) if out_ft.get('r_mean_temp_3').getInfo() not in missing_codes else out_ft.get('r_mean_temp_3').getInfo(), 
            float(out_ft.get('r_mean_temp_4').getInfo()) if out_ft.get('r_mean_temp_4').getInfo() not in missing_codes else out_ft.get('r_mean_temp_4').getInfo(), 
            float(out_ft.get('r_mean_temp_5').getInfo()) if out_ft.get('r_mean_temp_5').getInfo() not in missing_codes else out_ft.get('r_mean_temp_5').getInfo(), 
            float(out_ft.get('r_mean_temp_6').getInfo()) if out_ft.get('r_mean_temp_6').getInfo() not in missing_codes else out_ft.get('r_mean_temp_6').getInfo(), 
            float(out_ft.get('r_mean_temp_7').getInfo()) if out_ft.get('r_mean_temp_7').getInfo() not in missing_codes else out_ft.get('r_mean_temp_7').getInfo(), 
            float(out_ft.get('r_mean_temp_8').getInfo()) if out_ft.get('r_mean_temp_8').getInfo() not in missing_codes else out_ft.get('r_mean_temp_8').getInfo(), 
            float(out_ft.get('r_mean_temp_9').getInfo()) if out_ft.get('r_mean_temp_9').getInfo() not in missing_codes else out_ft.get('r_mean_temp_9').getInfo(), 
            float(out_ft.get('r_mean_temp_10').getInfo()) if out_ft.get('r_mean_temp_10').getInfo() not in missing_codes else out_ft.get('r_mean_temp_10').getInfo(), 
            float(out_ft.get('r_mean_temp_11').getInfo()) if out_ft.get('r_mean_temp_11').getInfo() not in missing_codes else out_ft.get('r_mean_temp_11').getInfo(), 
            float(out_ft.get('r_mean_temp_12').getInfo()) if out_ft.get('r_mean_temp_12').getInfo() not in missing_codes else out_ft.get('r_mean_temp_12').getInfo()
        ],
        "catchment":
        {
            ...
            "area_fractions": [
                float(out_ft.get('c_landcover_1').getInfo()) if out_ft.get('c_landcover_1').getInfo() not in missing_codes else out_ft.get('c_landcover_1').getInfo(), 
                float(out_ft.get('c_landcover_2').getInfo()) if out_ft.get('c_landcover_2').getInfo() not in missing_codes else out_ft.get('c_landcover_2').getInfo(), 
                float(out_ft.get('c_landcover_3').getInfo()) if out_ft.get('c_landcover_3').getInfo() not in missing_codes else out_ft.get('c_landcover_3').getInfo(), 
                float(out_ft.get('c_landcover_4').getInfo()) if out_ft.get('c_landcover_4').getInfo() not in missing_codes else out_ft.get('c_landcover_4').getInfo(), 
                float(out_ft.get('c_landcover_5').getInfo()) if out_ft.get('c_landcover_5').getInfo() not in missing_codes else out_ft.get('c_landcover_5').getInfo(), 
                float(out_ft.get('c_landcover_6').getInfo()) if out_ft.get('c_landcover_6').getInfo() not in missing_codes else out_ft.get('c_landcover_6').getInfo(),  
                float(out_ft.get('c_landcover_7').getInfo()) if out_ft.get('c_landcover_7').getInfo() not in missing_codes else out_ft.get('c_landcover_7').getInfo(), 
                float(out_ft.get('c_landcover_8').getInfo()) if out_ft.get('c_landcover_8').getInfo() not in missing_codes else out_ft.get('c_landcover_8').getInfo(), 
            ],
        ...
        "reservoir": {
            ...
            "area_fractions": [
                float(out_ft.get('r_landcover_bysoil_1').getInfo()) if out_ft.get('r_landcover_bysoil_1').getInfo() not in missing_codes else out_ft.get('r_landcover_bysoil_1').getInfo(), 
                float(out_ft.get('r_landcover_bysoil_2').getInfo()) if out_ft.get('r_landcover_bysoil_2').getInfo() not in missing_codes else out_ft.get('r_landcover_bysoil_2').getInfo(), 
                float(out_ft.get('r_landcover_bysoil_3').getInfo()) if out_ft.get('r_landcover_bysoil_3').getInfo() not in missing_codes else out_ft.get('r_landcover_bysoil_3').getInfo(), 
                float(out_ft.get('r_landcover_bysoil_4').getInfo()) if out_ft.get('r_landcover_bysoil_4').getInfo() not in missing_codes else out_ft.get('r_landcover_bysoil_4').getInfo(), 
                float(out_ft.get('r_landcover_bysoil_5').getInfo()) if out_ft.get('r_landcover_bysoil_5').getInfo() not in missing_codes else out_ft.get('r_landcover_bysoil_5').getInfo(), 
                float(out_ft.get('r_landcover_bysoil_6').getInfo()) if out_ft.get('r_landcover_bysoil_6').getInfo() not in missing_codes else out_ft.get('r_landcover_bysoil_6').getInfo(), 
                float(out_ft.get('r_landcover_bysoil_7').getInfo()) if out_ft.get('r_landcover_bysoil_7').getInfo() not in missing_codes else out_ft.get('r_landcover_bysoil_7').getInfo(), 
                float(out_ft.get('r_landcover_bysoil_8').getInfo()) if out_ft.get('r_landcover_bysoil_8').getInfo() not in missing_codes else out_ft.get('r_landcover_bysoil_8').getInfo(),  
                float(out_ft.get('r_landcover_bysoil_10').getInfo()) if out_ft.get('r_landcover_bysoil_10').getInfo() not in missing_codes else out_ft.get('r_landcover_bysoil_10').getInfo(), 
                float(out_ft.get('r_landcover_bysoil_11').getInfo()) if out_ft.get('r_landcover_bysoil_11').getInfo() not in missing_codes else out_ft.get('r_landcover_bysoil_11').getInfo(), 
                float(out_ft.get('r_landcover_bysoil_12').getInfo()) if out_ft.get('r_landcover_bysoil_12').getInfo() not in missing_codes else out_ft.get('r_landcover_bysoil_12').getInfo(), 
                float(out_ft.get('r_landcover_bysoil_13').getInfo()) if out_ft.get('r_landcover_bysoil_13').getInfo() not in missing_codes else out_ft.get('r_landcover_bysoil_13').getInfo(), 
                float(out_ft.get('r_landcover_bysoil_14').getInfo()) if out_ft.get('r_landcover_bysoil_14').getInfo() not in missing_codes else out_ft.get('r_landcover_bysoil_14').getInfo(), 
                float(out_ft.get('r_landcover_bysoil_15').getInfo()) if out_ft.get('r_landcover_bysoil_15').getInfo() not in missing_codes else out_ft.get('r_landcover_bysoil_15').getInfo(), 
                float(out_ft.get('r_landcover_bysoil_16').getInfo()) if out_ft.get('r_landcover_bysoil_16').getInfo() not in missing_codes else out_ft.get('r_landcover_bysoil_16').getInfo(), 
                float(out_ft.get('r_landcover_bysoil_17').getInfo()) if out_ft.get('r_landcover_bysoil_17').getInfo() not in missing_codes else out_ft.get('r_landcover_bysoil_17').getInfo()
            ],
            "soil_carbon": float(out_ft.get('r_msocs_kgperm2').getInfo()) if out_ft.get('r_msocs_kgperm2').getInfo() not in missing_codes else out_ft.get('r_msocs_kgperm2').getInfo() 
        }
    }
...
def batch_export_to_json(output_folder_path):
    ...
    dams_ftc = (
        ee.FeatureCollection(cfg.dams_table_path)
    )
