...
def jensen_snap_hydroriver(dam_feature: ee.Feature) -> ee.Feature:
    ...
    in FREEFLOWINGRIVERS Feature Collection"""
    ...
    r_ftc = dta.FREEFLOWINGRIVERS.filterBounds(search_area).map(
...
if __name__ == "__main__":
    ...
    interReaches = dta.FREEFLOWINGRIVERS.filterBounds(snappedDamFeat.geometry())
