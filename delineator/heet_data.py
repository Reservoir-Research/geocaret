...
FLOWACCUMULATION_NAME = "WWF/HydroSHEDS/15ACC"
# Hydrosheds
...
FREEFLOWINGRIVERS_NAME = ee.FeatureCollection("WWF/HydroSHEDS/v1/FreeFlowingRivers")
...
HYDROSHEDS_DD_NAME = "WWF/HydroSHEDS/15DIR"
...
# www.hydrosheds.org
HYDROBASINS12_NAME = "WWF/HydroSHEDS/v1/Basins/hybas_12"
...
hydrosheds_dict = ee.Dictionary(
    {
        "1": ee.FeatureCollection("WWF/HydroSHEDS/v1/Basins/hybas_1"),
        "2": ee.FeatureCollection("WWF/HydroSHEDS/v1/Basins/hybas_2"),
        "3": ee.FeatureCollection("WWF/HydroSHEDS/v1/Basins/hybas_3"),
        "4": ee.FeatureCollection("WWF/HydroSHEDS/v1/Basins/hybas_4"),
        "5": ee.FeatureCollection("WWF/HydroSHEDS/v1/Basins/hybas_5"),
        "6": ee.FeatureCollection("WWF/HydroSHEDS/v1/Basins/hybas_6"),
        "7": ee.FeatureCollection("WWF/HydroSHEDS/v1/Basins/hybas_7"),
        "8": ee.FeatureCollection("WWF/HydroSHEDS/v1/Basins/hybas_8"),
        "9": ee.FeatureCollection("WWF/HydroSHEDS/v1/Basins/hybas_9"),
        "10": ee.FeatureCollection("WWF/HydroSHEDS/v1/Basins/hybas_10"),
        "11": ee.FeatureCollection("WWF/HydroSHEDS/v1/Basins/hybas_11"),
        "12": ee.FeatureCollection("WWF/HydroSHEDS/v1/Basins/hybas_12"),
    }
)
...
FREEFLOWINGRIVERS = ee.FeatureCollection(FREEFLOWINGRIVERS_NAME)
