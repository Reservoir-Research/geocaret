...
def delineate_future_reservoir(catchmentVector, c_dam_id_str):
    ...
    mad_m3_pers = ee.Number(catchFeat.get("c_mad_m3_pers"))
    ...
    if debug_mode == True:
        ...
        print(
            ...
            snapped_dam_point_location.getInfo(),
        )
    ...
    reservoirVector = ee.Feature(reservoirVector).set(
        "d_dam_elevation", dam_elevation_str
    )
...
def delineate_existing_reservoir(
    ...
    if debug_mode == True:
        ...
        print(
            "\n [delineate_existing_reservoir] snapped_point_location",
            snapped_dam_point_location.getInfo(),
        )
        print(
