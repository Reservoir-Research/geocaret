# Application's own event framework
* Supports own (internal) and external event handlers
* Provides interface for EventHandlers, Events and EventListeners
## UML Diagram of the class structure
[UML Class Diagram](event_handler_listener.md)
```mermaid
classDiagram
    class Logic {
        +events: EventHandler
