...
# Choose resolution of hydrologically conditioned DEM
# Choose from:
# - "03"
# - "15"
hydrodataset = "03"

# Use raw/snapped dam location for reservoir delineation
delineate_snapped = True

# ==============================================================================
# Export Options
# ==============================================================================

# Turn off export to drive
# by default to reduce run time for long batches
