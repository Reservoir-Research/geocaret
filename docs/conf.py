#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# GeoCARET documentation build configuration file, created by T. Janus
# 30-07-2024
#
...
latex_documents = [
    (master_doc, "GeoCARET.tex", "GeoCARET Documentation", "Tomasz Janus", "manual"),
]

# One entry per manual page. List of tuples
# (source start file, name, description, authors, manual section).
man_pages = [(master_doc, "geocaret", "GeoCARET Documentation", [author], 1)]
