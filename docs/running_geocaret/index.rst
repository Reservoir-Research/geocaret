...
GeoCARET_ can be run as a **Python package** (standard) or as a **Docker image** (optional - see :doc:`../installation/using_docker` for a short description of what Docker is) depending on the chosen installation option - see :doc:`../installation/index`.  
...
For detailed instructions how to run GeoCARET as a Python package and/or as a Docker image, navigate to  :doc:`running_python_package` and :doc:`running_docker`, respectively.
