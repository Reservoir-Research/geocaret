...
def main():
    ...
    with yaspin(Spinners.line, text=step_desc, color="yellow") as sp:
        ...
        ee_authenticated = is_authenticated(project)
    ...
    heet_settings = {
        ...
        "jobname": (args.jobname).upper(),
        "outputs": args.outputs,
        "jensen_search_radius": cfg.jensen_search_radius,
        "upstreamMethod": cfg.upstreamMethod,
        "paramHydroDEM": cfg.paramHydroDEM,
        "resHydroDEM": cfg.resHydroDEM,
        "hydrodataset": cfg.hydrodataset,
        "delineate_snapped": cfg.delineate_snapped,
        "export_to_drive": cfg.export_to_drive,
        "direct_to_vis": cfg.direct_to_vis,
    }
    ...
    with yaspin(Spinners.line, text=step_desc, color="yellow") as sp:
        ...
        if cfg.direct_to_vis == True:
            ...
            sp.write(
                f"  https://code.earthengine.google.com/1edb73329689c90315aa8307336208cb?noload=true"
            )
        sp.write("")
        sp.write("Thank you for using HEET!")
