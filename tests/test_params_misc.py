...
def test_predominant_biome():
    ...
    logger.info(
        f"[test_predominant_biome] Predominant Biome - HEET {calc_result} "
...
def test_population():
    ...
    logger.info(
        f"[test_population_px4] Population - HEET {calc_result} "
        + f"Manual {test_result} Diff {diff} PDiff {pdiff}"
    )
...
def test_fekete_crossref_ro():
    ...
    logger.info(
        f"[test_fekete_crossref_ro] - HEET Fekete {calc_result} "
