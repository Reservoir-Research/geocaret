...
def test_delineate_future_reservoir_input_we():
    ...
    def remove_all_properties(feat):
        ...
        target_properties = ft_property_names.filter(ee.Filter.neq("item", ""))
...
def test_delineate_future_reservoir_input_pc():
    """Test that future reservoir delineation produces the same result
...
def test_delineate_future_reservoir_input_dh():
    """Test that future reservoir delineation produces the same result
    ...
    def remove_all_properties(feat):
        ft_property_names = feat.propertyNames()
        target_properties = ft_property_names.filter(
            ee.Filter.neq("item", ft_property_names)
        )
        return feat.select(target_properties)
